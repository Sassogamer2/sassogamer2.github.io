var images = [
    "accountant.png", "chef.jpg", "dentist.jpg", "doctor.jpg", "electrician.jpg", 
    "farmer.jpg", "journalist.jpg", "lawyer.jpg", "police officer.png", "waiter.jpg", 
    "taxi driver.jpg", "teacher.jpg"
];
...
if (imageName == "waiter") {
    imageName = Math.random() <= 0.5 ? "waiter" : "waitress";
}
